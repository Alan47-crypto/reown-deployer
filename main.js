...
// =========================================================================================
// This is the Project ID from your code snippet
...
const contractABI = [{
  ...
  "sourceName": "contracts/FHECounter.sol",
...
const addressDiv = document.getElementById('contractAddress');

// 2. Setup the WalletKit instance
const core = new Core({
  projectId: WALLETCONNECT_PROJECT_ID
});

const metadata = {
  name: 'Zama HFE contract deployer',
  description: 'AppKit Example',
  url: window.location.href, // Use the current page's URL
  icons: ['https://assets.reown.com/reown-profile-pic.png']
};

let walletKit; // We will initialize this when the user clicks

// 3. Add the main logic to our button
deployButton.addEventListener('click', async () => {
  try {
    ...
    if (session.namespaces.eip155.chains[0] !== 'eip155:11155111') {
        throw new Error("Please connect to the Sepolia Testnet in your wallet.");
    }
    
    // 3.2 Get the provider and signer from WalletKit
